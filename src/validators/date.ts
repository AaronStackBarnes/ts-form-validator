...
/** @deprecated Use DateValidationResult instead */
export type ValidationResult = DateValidationResult;
...
export function validateDate(input: unknown, opts: DateValidationOptions = {}): DateValidationResult {
  const {
    min,
    max,
    allowFuture = true,
