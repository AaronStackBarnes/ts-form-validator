...
/** @deprecated Use UrlValidationResult instead */
export type ValidationResult = UrlValidationResult;
...
export function validateUrl(input: string, opts: UrlValidationOptions = {}): UrlValidationResult {
  const {
